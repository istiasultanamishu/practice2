  ...
  jQuery.fn.entry = function (a) {
    ...
    if ("undefined" == typeof a.e)
      ...
      var b = a.e,
        ...
        e =
          b.offsetX ||
          b.clientX - n(b.target).offset().left + window.pageXOffset,
        b =
          b.offsetY ||
          b.clientY - n(b.target).offset().top + window.pageYOffset;
      e < d / 2
        ? ((h = a.invert ? a.sides[1] : a.sides[3]), (l = e), (f = 0))
        : e > d / 2 &&
          e - d <= d / 2 &&
          ((h = a.invert ? a.sides[3] : a.sides[1]),
          (l = b < c / 2 ? d - e : e - d),
          (f = 1));
      b < c / 2
        ? ((k = a.invert ? a.sides[2] : a.sides[0]), (m = b), (g = 0))
        : b > c / 2 &&
          b - c <= c / 2 &&
          ((k = a.invert ? a.sides[0] : a.sides[2]),
          (m = e < d / 2 ? c - b : b - c),
          (g = 1));
      if (1 == f && 1 == g) p = l > m ? h : k;
      else if ((0 == f && 0 == g) || (1 == f && 0 == g) || (0 == f && 1 == g))
        p = l < m ? h : k;
      return p;
    }
  };
